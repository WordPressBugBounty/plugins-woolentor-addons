<?php
/**
 * Offer Banner — Luxury / Variant 1.
 *
 * Three wide cards on the pack's light ground, each a photograph under a deep obsidian scrim.
 * A gold pill tag, a tight Sora headline, a muted two-line note, and a call to action underlined
 * in gold that turns gold on hover. The card lifts five pixels and drops a soft shadow.
 *
 * Reference: design-reference/new_temlate/luxury-style/v1/home-luxury.html:7737
 * — `.promo-banner-grid .promo-banner-card`
 *
 * The reference's call to action carries no arrow, so none is passed here.
 *
