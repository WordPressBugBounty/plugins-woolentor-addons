<?php
/**
 * Marquee — Editorial / Variant 2.
 *
 * A kinetic campaign band: large white italic serif phrases drifting across a near-black
 * ground, each followed by a small sky-blue star. The loudest marquee in the set.
 *
 ...
 *
 * Reference: design-reference/new_temlate/editorial-style/v2/homepage.html:5701 — `.camp-marquee`
 *
...
<div class="<?php echo esc_attr( $this->band_classes( $marquee ) ); ?>"
    ...
    aria-label="<?php echo esc_attr__( 'Campaign', 'woolentor' ); ?>">
