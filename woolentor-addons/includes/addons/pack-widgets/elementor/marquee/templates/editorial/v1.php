<?php
/**
 * Marquee — Editorial / Variant 1.
 *
 * A labelled partner strip: a small letter-spaced lead above a warm-white band of large serif
 * names, held far back at low opacity and lifting a little on hover. Sand dots between them.
 *
 ...
 *
 * Reference: design-reference/new_temlate/editorial-style/v1/home-editorial.html:3263 — `.section-partners`
 *
...
<div class="<?php echo esc_attr( $this->band_classes( $marquee ) ); ?>"
    ...
    aria-label="<?php echo esc_attr__( 'Partners', 'woolentor' ); ?>">
