<?php
/**
 * Marquee — Editorial / Variant 3.
 *
 * A restrained paper-white band: small uppercase claims in olive with wide letter-spacing and a
 * clay diamond between them. Deliberately the quietest of the three editorial marquees, since
 * v1 leans on large serif names and v2 on large italic phrases.
 *
 ...
 * pack's own paper-white, clay and soft-sand palette rather than borrowed from a neighbour.
 *
