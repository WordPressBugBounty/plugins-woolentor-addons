<?php
/**
 * Marquee — Luxury / Variant 2.
 *
 * A pale sage promise band: a small olive icon beside each letter-spaced claim, parted by a
 * lime dot. Roomy padding and a wide fade make it read as a breath between sections.
 *
 ...
 *
 * Reference: design-reference/new_temlate/luxury-style/v2/homepage.html:4379 — `.values`
 *
...
<div class="<?php echo esc_attr( $this->band_classes( $marquee ) ); ?>"
    ...
    aria-label="<?php echo esc_attr__( 'Our promise', 'woolentor' ); ?>">
