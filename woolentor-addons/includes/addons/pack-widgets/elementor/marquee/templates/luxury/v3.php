<?php
/**
 * Marquee — Luxury / Variant 3.
 *
 * A press row on white: charcoal names held back at low opacity, lifting to full on hover,
 * spaced far apart with hairline edges above and below.
 *
 * The reference gives each masthead its own face and size. One repeater cannot carry eight
 * hand-tuned type treatments, so every name shares one style here — set the image field instead
 * when real logotypes matter.
 *
 ...
 *
 * Reference: design-reference/new_temlate/luxury-style/v3/homepage.html:5128 — `.brands`
 *
...
<div class="<?php echo esc_attr( $this->band_classes( $marquee ) ); ?>"
    ...
    aria-label="<?php echo esc_attr__( 'As seen in', 'woolentor' ); ?>">
