<?php
/**
 * Marquee — Modern / Variant 2.
 *
 * A thin dark announcement strip: tiny uppercase claims in dimmed white, parted by an olive
 * star. Sits directly under the hero, so it stays quiet and short.
 *
 ...
 *
 * Reference: design-reference/new_temlate/modern-style/v2/homepage.html:5494 — `.marquee`
 *
...
<div class="<?php echo esc_attr( $this->band_classes( $marquee ) ); ?>"
    ...
    aria-label="<?php echo esc_attr__( 'Announcements', 'woolentor' ); ?>">
