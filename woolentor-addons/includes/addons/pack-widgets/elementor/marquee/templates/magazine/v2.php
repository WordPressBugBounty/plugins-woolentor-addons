<?php
/**
 * Marquee — Magazine / Variant 2.
 *
 * A rounded dark pill floating under the hero, carrying widely spaced category words in white
 * with a small coral star between them.
 *
 ...
 *
 * Reference: design-reference/new_temlate/magazine-style/v2/homepage.html:5339 — `.strip`
 *
...
<div class="<?php echo esc_attr( $this->band_classes( $marquee ) ); ?>"
    ...
    aria-label="<?php echo esc_attr__( 'Collections', 'woolentor' ); ?>">
