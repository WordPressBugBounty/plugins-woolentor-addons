<?php
/**
 * Marquee — Magazine / Variant 1.
 *
 * A trending ticker at full volume: black uppercase headlines on cyber yellow, banded top and
 * bottom by a heavy black rule. Highlighted items turn signal red, which is how prices and
 * discounts read in the reference.
 *
 ...
 *
 * Reference: design-reference/new_temlate/magazine-style/v1/home-magazine.html:6780
 * — `.trending-marquee`
 *
...
<div class="<?php echo esc_attr( $this->band_classes( $marquee ) ); ?>"
    ...
    aria-label="<?php echo esc_attr__( 'Trending now', 'woolentor' ); ?>">
