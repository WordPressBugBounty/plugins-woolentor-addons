<?php
/**
 * Product Showcase — Luxury / Variant 3.
 *
 * A header with the copy left and a gold-underlined text link right, over a four-across grid of
 * frameless 4:5 cards. The reference carries no tab row; if one is ever offered it sits under the
 * headline.
 *
 * Reference: design-reference/new_temlate/luxury-style/v3/homepage.html:4476 — `.arrivals-grid`
 *
