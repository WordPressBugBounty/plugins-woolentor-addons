<?php
/**
 * Product Showcase — Luxury / Variant 2.
 *
 * Split header — an eyebrow with a leading rule over a Cormorant headline whose accent runs
 * italic olive, and a row of plain text tabs on the right that underline as they activate — over
 * a four-across grid, with a dark button centred beneath.
 *
 * Reference: design-reference/new_temlate/luxury-style/v2/homepage.html:4552 — `.prod__grid`
 *
...
$wl_ps_view_all = $this->view_all_link( $header['view_all'], $this->arrow( 13 ) );
