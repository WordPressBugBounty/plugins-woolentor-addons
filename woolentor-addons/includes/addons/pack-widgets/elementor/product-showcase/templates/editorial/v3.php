<?php
/**
 * Product Showcase — Editorial / Variant 3.
 *
 * A header that pushes the copy block left and an underlined text link right, over a four-across
 * grid of borderless 4:5 cards. The reference carries no tab row; if the user adds one it sits
 * under the headline.
 *
 * Reference: design-reference/new_temlate/editorial-style/v3/homepage.html:4641 — `.products__grid`
 *
...
$wl_ps_view_all = $this->view_all_link( $header['view_all'] );
