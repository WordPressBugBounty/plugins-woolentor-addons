<?php
/**
 * Product Showcase — Editorial / Variant 1.
 *
 * Two-column header — a clay kicker over a large serif headline on the left, an underlined text
 * tab row on the right — over a four-across grid of square-image cards. The reference has no
 * "view all" link, so the widget's own is drawn only if the user adds one.
 *
 * Reference: design-reference/new_temlate/editorial-style/v1/home-editorial.html:6109 — `.feat-grid`
 *
