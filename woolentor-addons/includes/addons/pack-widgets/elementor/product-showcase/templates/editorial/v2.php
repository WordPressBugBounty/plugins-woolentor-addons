<?php
/**
 * Product Showcase — Editorial / Variant 2.
 *
 * Split header — a primary-blue eyebrow with a leading rule over a Playfair headline whose accent
 * runs italic, and a row of outlined square tab buttons on the right — over a four-across grid of
 * 3:4 cards, with a centred outline "View All" button beneath.
 *
 * Reference: design-reference/new_temlate/editorial-style/v2/homepage.html:4858 — `.products`
 *
