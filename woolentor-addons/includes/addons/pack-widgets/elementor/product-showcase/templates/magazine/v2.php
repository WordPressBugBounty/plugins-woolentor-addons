<?php
/**
 * Product Showcase — Magazine / Variant 2.
 *
 * Split header — a starred label over a very large condensed headline with a coral accent, and a
 * dark "View All" button on the right — over a four-across grid of rounded cards.
 *
 * Reference: design-reference/new_temlate/magazine-style/v2/homepage.html:5351 — `.prod-grid`
 *
