<?php
/**
 * Product Showcase — Magazine / Variant 3.
 *
 * A terracotta label over a serif headline on the left and an underlined "View all" on the right,
 * over a four-across grid of quiet, centred cards.
 *
 * Reference: design-reference/new_temlate/magazine-style/v3/homepage.html:4967 — `.best-sellers__grid`
 *
