<?php
/**
 * Shop the Look — Luxury / Variant 3: the room study.
 *
 * Adapted from `design-reference/new_temlate/luxury-style/v3/homepage.html` — `.room-study`.
 * Structurally the same section as Editorial V3's, and the same adaptation: the layout, the copy
 * and the product rows were already drawn, and the pins are what this widget adds. The one
 * difference the pack makes is its panel, which is dark — a charcoal block beside the photograph
 * rather than a page-coloured one.
 *
