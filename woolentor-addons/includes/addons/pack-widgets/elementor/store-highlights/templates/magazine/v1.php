<?php
/**
 * Store Highlights — Magazine / Variant 1.
 *
 * Solid black strip with rounded corners, split into equal cells by short inset hairlines.
 * A large yellow icon sits beside a tight white title and a dimmed second line.
 *
 * Reference: design-reference/new_temlate/magazine-style/v1/home-magazine.html:6723 — `.hero-strip`
 *
